    ...
    <>
      ...
      <section className="shell section method-support">
        <div className="method-support-card current-support">
          ...
          <p>Cases, evidence items, hypotheses, tasks, confidence values, source-coverage checks, and date-conflict checks are implemented in the source product. {betaStatus.rollout}</p>
        </div>
