...
const dataSourceRoutes = [
  ...
  { method: "GET", path: "/api/integrations/source-1/artifacts/artifact-1/download", file: "app/api/integrations/[id]/artifacts/[artifactId]/download/route.ts" },
  { method: "POST", path: "/api/integrations/source-1/artifacts/stage", file: "app/api/integrations/[id]/artifacts/stage/route.ts" },
  { method: "POST", path: "/api/integrations/source-1/artifacts/complete", file: "app/api/integrations/[id]/artifacts/complete/route.ts" },
