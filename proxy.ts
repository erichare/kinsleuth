...
const protectedApiPrefixes = ["/api/ai", "/api/cases", "/api/dna", "/api/imports", "/api/people", "/api/publishing", "/api/reports", "/api/uploads"];
...
export const config = {
  matcher: ["/app/:path*", "/api/ai/:path*", "/api/cases/:path*", "/api/dna/:path*", "/api/imports/:path*", "/api/people/:path*", "/api/publishing/:path*", "/api/reports/:path*", "/api/uploads/:path*"]
};
